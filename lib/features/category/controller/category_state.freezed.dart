...
class _$CategoryStateSuccess implements CategoryStateSuccess {
  const _$CategoryStateSuccess({required final List<Category> categories})
...
abstract class CategoryStateSuccess implements CategoryState {
  const factory CategoryStateSuccess(
      {required final List<Category> categories}) = _$CategoryStateSuccess;
